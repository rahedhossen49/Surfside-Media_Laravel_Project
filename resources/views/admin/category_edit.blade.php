    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.category.update')}}" method="POST"
                ...
                <fieldset class="name">
                    <div class="body-title">Edit Category Name <span class="tf-color-1">*</span></div>
                    <input class="flex-grow" type="text" placeholder="Edit Category name" name="name"
                ...
                @enderror
                <fieldset class="name">
                    <div class="body-title">Edit Category Slug <span class="tf-color-1">*</span></div>
                    <input class="flex-grow" type="text" placeholder="Edit Category Slug" name="slug"
