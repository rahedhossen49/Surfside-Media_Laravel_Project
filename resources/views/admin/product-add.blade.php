    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <form class="tf-section-2 form-add-product" method="POST"
                enctype="multipart/form-data"action="{{ route('admin.product.store') }}">
                @csrf
                <div class="wg-box">
                    <fieldset class="name">
    ...
    <script>
        $(function() {
            ...
            $("#gFile").on("change", function(e) {
                ...
                const [file] = this.files;
                $.each(photoInp[0].files, function(key, val) {
                    $('#galUpload').prepend(
                        `<div class="item gitem"><img src="${URL.createObjectURL(val)}"/></div>`
                    );
                });
            });
