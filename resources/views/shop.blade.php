...
<main class="pt-90">
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
              ...
              <option value="48" {{$size == 48 ? 'selected' : ''}}>44</option>
        ...
        @foreach ($products as $product )
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                ...
                <a href="{{route('cart.index')}}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart btn btn-warning mb-3">Go to Cart</a>
                @else
                ...
                <button
                 type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart"
  ...
  <form id="frmfilter" method="GET" action="{{route('shop.index')}}">
    ...
    <input type="hidden" name="brands" id="hdnBrands" value="{{ old('brands', $f_brands) }}"/>
  </form>
