          ...
          <div class="checkout__totals-wrapper">
            <div class="sticky-content">
              ...
              <div class="checkout__payment-methods">
                ...
                <div class="form-check">
                    <input class="form-check-input form-check-input_fill" type="radio" name="mode" value="bkash"
                      id="mode3">
                    <label class="form-check-label" for="checkout_payment_method_4">
                      Bkash
                ...
                <div class="form-check">
                    <input class="form-check-input form-check-input_fill" type="radio" name="mode" value="nagad"
                      id="mode4">
                    <label class="form-check-label" for="checkout_payment_method_4">
                      Nagad
